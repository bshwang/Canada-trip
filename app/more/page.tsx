...
import { Car, BookmarkCheck, Camera, Backpack, Info, ChevronRight, Wallet, Shield, Save, UserCircle } from "lucide-react";
...
const links = [
  ...
  { href: "/account",      label: "계정 / 동기화",    icon: UserCircle,    color: "text-sky2" },
